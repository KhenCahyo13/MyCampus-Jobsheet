                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="functions/hapus.php?anggota=hapus&id=<?php echo $row['user_id']; ?>" onclick="javascript:return confirm('Hapus Data Anggota ?');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o" aria-hidden="true"></i> Hapus</a>
                                </td>
                            </tr>
                        <?php
                        }
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="functions/tambah.php?anggota=tambah" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="level" name aria-
                                        label="Default select example">
