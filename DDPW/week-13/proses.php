<?php
    ...
    if ($aksi == 'tambah') {
        ...
        if (sqlsrv_query($connection, $query)) {
            ...
            echo "Gagal menambahkan data: " . sqlsrv_error($connection);
        }
    } else if ($aksi == 'ubah') {
        if (isset($_POST['id'])) {
            $id = $_POST['id'];
            ...
            if (sqlsrv_query($connection, $query)) {
                ...
                echo "Gagal mengupdate data: " . sqlsrv_error($connection);
            }
        } else {
            echo "ID tidak valid.";
        }
        ...
        if (isset($_GET['id'])) {
            ...
            if (sqlsrv_query($connection, $query)) {
                ...
                echo "Gagal menghapus data: " . sqlsrv_error($connection);
            }
        } else {
            echo "ID tidak valid.";
        }
